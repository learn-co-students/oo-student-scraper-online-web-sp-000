...
class Scraper
  ...
  def self.scrape_profile_page(profile_url)
    ...
    student_bio = doc.css(".vitals-container .social-icon-container a")
    student_bio.each do |element|
   ...
   return_hash[:bio] = doc.css(".bio-block.details-block .description-holder p").text
